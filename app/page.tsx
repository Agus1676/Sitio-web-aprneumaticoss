        ...
        <section id="contacto" className="py-20 bg-muted/30">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <a href="https://wa.me/54911..." target="_blank" className="flex flex-col items-center p-6 bg-background rounded-xl shadow-sm hover:shadow-md transition-all border border-border group">
              ...
              <a href="https://instagram.com/aprmoneumaticos" target="_blank" className="flex flex-col items-center p-6 bg-background rounded-xl shadow-sm hover:shadow-md transition-all border border-border group">
              ...
              <a href="tel:+5491145678900" className="flex flex-col items-center p-6 bg-background rounded-xl shadow-sm hover:shadow-md transition-all border border-border group">
                ...
                <p className="text-muted-foreground text-sm text-center mt-2">(011) 4567-8900</p>
              </a>
